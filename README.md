...
Navbar.tsx | Tricky one. Height given h-20 parent. Then create two layout for Mobile and Bigger Screens which is different code. Bigger screen use w-1/3, w-2/3 and w-1/2, w-1/2
